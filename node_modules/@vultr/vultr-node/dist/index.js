exports.initialize = function (config) {
    ...
    var backups = require('./api/backups');
    var bareMetal = require('./api/bare-metal');
    var billing = require('./api/billing');
    var blockStorage = require('./api/block-storage');
    var dns = require('./api/dns');
    var firewall = require('./api/firewall');
    var instances = require('./api/instances');
    var iso = require('./api/iso');
    var kubernetes = require('./api/kubernetes');
    var loadBalancers = require('./api/load-balancers');
    var objectStorage = require('./api/object-storage');
    var operatingSystems = require('./api/operating-systems');
    var plans = require('./api/plans');
    var privateNetworks = require('./api/private-networks');
    var regions = require('./api/regions');
    var reservedIps = require('./api/reserved-ips');
    var snapshots = require('./api/snapshots');
    var sshKeys = require('./api/ssh-keys');
    var startupScripts = require('./api/startup-scripts');
     ...
     */
    var createRequestFunction = function (endpoint) {
        return function (parameters) {
            ...
            if (endpoint.apiKeyRequired) {
                if (userConfiguration === undefined || !userConfiguration.apiKey) {
                    ...
                    throw new Error("API key required for ".concat(endpoint.url));
                }
            }
                ...
                if (parameters) {
                    if (typeof parameters !== 'object') {
                        ...
                        for (var parameter in endpoint.parameters) {
                            var endpointParameter = endpoint.parameters[parameter];
                            var userParameter = parameters[parameter];
                            if (endpointParameter.required && !userParameter) {
                                // Parameters for the request are required, but none were passed in
                                throw new Error("Missing parameter: ".concat(parameter));
                            }
                                ...
                                if (endpointParameter.type === 'array' &&
                                    ...
                                    throw new Error("Invalid parameter type for ".concat(parameter, ", expected ").concat(endpointParameter.type));
                                }
                                else if (endpointParameter.type === 'number' &&
                                    isNaN(Number(userParameter))) {
                                    // Request requires a number but special character or alpha character was passed in
                                    throw new Error("Invalid parameter type for ".concat(parameter, ", expected ").concat(endpointParameter.type));
                                }
                                else if (endpointParameter.type !== 'array' &&
                        ...
                        return util.makeApiRequest(userConfiguration, endpoint, requestParameters);
                    }
                }
                else {
    ...
    return {
        ...
        bareMetal: {
            ...
            getInstanceIpv4Addresses: createRequestFunction(bareMetal.getInstanceIpv4Addresses),
            getInstanceIpv6Addresses: createRequestFunction(bareMetal.getInstanceIpv6Addresses),
            ...
            getInstanceBandwidth: createRequestFunction(bareMetal.getInstanceBandwidth),
            ...
            getInstanceAvailableUpgrades: createRequestFunction(bareMetal.getInstanceAvailableUpgrades),
        ...
        instances: {
            ...
            getInstanceBandwidth: createRequestFunction(instances.getInstanceBandwidth),
            getInstanceNeighbors: createRequestFunction(instances.getInstanceNeighbors),
            listInstancePrivateNetworks: createRequestFunction(instances.listInstancePrivateNetworks),
            getInstanceIsoStatus: createRequestFunction(instances.getInstanceIsoStatus),
            attachIsoToInstance: createRequestFunction(instances.attachIsoToInstance),
            detachIsoFromInstance: createRequestFunction(instances.detachIsoFromInstance),
            attachPrivateNetworkToInstance: createRequestFunction(instances.attachPrivateNetworkToInstance),
            detachPrivateNetworkFromInstance: createRequestFunction(instances.detachPrivateNetworkFromInstance),
            setInstanceBackupSchedule: createRequestFunction(instances.setInstanceBackupSchedule),
            getInstanceBackupSchedule: createRequestFunction(instances.getInstanceBackupSchedule),
            restoreInstance: createRequestFunction(instances.restoreInstance),
            listInstanceIpv4Information: createRequestFunction(instances.listInstanceIpv4Information),
            createInstanceIpv4: createRequestFunction(instances.createInstanceIpv4),
            getInstanceIpv6Information: createRequestFunction(instances.getInstanceIpv6Information),
            createInstanceReverseIpv6: createRequestFunction(instances.createInstanceReverseIpv6),
            listInstanceIpv6ReverseInformation: createRequestFunction(instances.listInstanceIpv6ReverseInformation),
            createInstanceReverseIpv4: createRequestFunction(instances.createInstanceReverseIpv4),
            ...
            setDefaultReverseDnsEntry: createRequestFunction(instances.setDefaultReverseDnsEntry),
            deleteIpv4Address: createRequestFunction(instances.deleteIpv4Address),
            deleteInstanceReverseIpv6: createRequestFunction(instances.deleteInstanceReverseIpv6),
            getAvailableInstanceUpgrades: createRequestFunction(instances.getAvailableInstanceUpgrades)
        },
        iso: {
        ...
        loadBalancers: {
            ...
            createLoadBalancer: createRequestFunction(loadBalancers.createLoadBalancer),
            getLoadBalancer: createRequestFunction(loadBalancers.getLoadBalancer),
            updateLoadBalancer: createRequestFunction(loadBalancers.updateLoadBalancer),
            deleteLoadBalancer: createRequestFunction(loadBalancers.deleteLoadBalancer),
            listForwardingRules: createRequestFunction(loadBalancers.listForwardingRules),
            createForwardingRule: createRequestFunction(loadBalancers.createForwardingRule),
            getForwardingRule: createRequestFunction(loadBalancers.getForwardingRule),
            deleteForwardingRule: createRequestFunction(loadBalancers.deleteForwardingRule),
        ...
        kubernetes: {
            createKubernetesCluster: createRequestFunction(kubernetes.createKubernetesCluster),
            listKubernetesClusters: createRequestFunction(kubernetes.listKubernetesClusters),
            getKubernetesCluster: createRequestFunction(kubernetes.getKubernetesCluster),
            updateKubernetesCluster: createRequestFunction(kubernetes.updateKubernetesCluster),
            deleteKubernetesCluster: createRequestFunction(kubernetes.deleteKubernetesCluster),
            deleteKubernetesClusterAndResources: createRequestFunction(kubernetes.deleteKubernetesClusterAndResources),
            getKubernetesResources: createRequestFunction(kubernetes.getKubernetesResources),
            ...
            deleteNodePoolInstance: createRequestFunction(kubernetes.deleteNodePoolInstance),
            recycleNodePoolInstance: createRequestFunction(kubernetes.recycleNodePoolInstance),
            getKubernetesClusterKubeconfig: createRequestFunction(kubernetes.getKubernetesClusterKubeconfig),
            getKubernetesVersions: createRequestFunction(kubernetes.getKubernetesVersions)
        },
        objectStorage: {
            listObjectStorages: createRequestFunction(objectStorage.listObjectStorages),
            createObjectStorage: createRequestFunction(objectStorage.createObjectStorage),
            getObjectStorage: createRequestFunction(objectStorage.getObjectStorage),
            deleteObjectStorage: createRequestFunction(objectStorage.deleteObjectStorage),
            updateObjectStorage: createRequestFunction(objectStorage.updateObjectStorage),
            regenerateObjectStorageKeys: createRequestFunction(objectStorage.regenerateObjectStorageKeys),
        ...
        privateNetworks: {
            getPrivateNetwork: createRequestFunction(privateNetworks.getPrivateNetwork),
            deletePrivateNetwork: createRequestFunction(privateNetworks.deletePrivateNetwork),
            updatePrivateNetwork: createRequestFunction(privateNetworks.updatePrivateNetwork),
            listPrivateNetworks: createRequestFunction(privateNetworks.listPrivateNetworks),
            createPrivateNetwork: createRequestFunction(privateNetworks.createPrivateNetwork)
        },
        regions: {
            listRegions: createRequestFunction(regions.listRegions),
            listAvailableComputeInRegion: createRequestFunction(regions.listAvailableComputeInRegion)
        },
        reservedIps: {
            ...
            convertInstanceIpToReservedIp: createRequestFunction(reservedIps.convertInstanceIpToReservedIp)
        },
        snapshots: {
            ...
            createSnapshotFromUrl: createRequestFunction(snapshots.createSnapshotFromUrl)
        },
        sshKeys: {
        ...
        startupScripts: {
            ...
            deleteStartupScript: createRequestFunction(startupScripts.deleteStartupScript),
            updateStartupScript: createRequestFunction(startupScripts.updateStartupScript),
            listStartupScripts: createRequestFunction(startupScripts.listStartupScripts),
            createStartupScript: createRequestFunction(startupScripts.createStartupScript)
        },
        users: {
